...
handle_event(#wx{event = #wxCommand{type = command_text_enter, cmdString = Item}},
    ...
    case Cmd of
        ...
        {join, Channel} ->
            ...
            case Result of
                ok ->
                    write_channel(join_ids(ClientID, ?SYSTEM), "+ Joined " ++ Channel),
        ...
        {nick, Nick} ->
            ...
            case Result of
                ok ->
                    write_channel(join_ids(ClientID, ?SYSTEM),
...
leave_channel(ClientID, ClientName, Panel, Channel) ->
    case Channel of
        ...
        Channel ->
            ...
            case Result of
                ok ->
                    close_tab(join_ids(ClientID, ?NOTEBOOK), Channel),
